...
public class GetPagedHandler : PagedRepositoryHandlerBase<GetPagedQuery, Models.ActivityType>
{
    ...
    public override async Task<IPagedResult<Models.ActivityType>> Handle(GetPagedQuery request, CancellationToken cancellationToken)
    {
