...
public class GetPagedHandler : PagedRepositoryHandlerBase<GetPaged, TransactionType>
{
    ...
    public override async Task<IPagedResult<TransactionType>> Handle(GetPaged request, CancellationToken cancellationToken)
    {
